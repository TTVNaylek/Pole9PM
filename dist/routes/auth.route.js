...
router.post("/otp/verify", otpSystem_1.default.VerifyOTP);
router.post("/otp/validate", otpSystem_1.default.ValidateOTP);
router.post("/otp/disable", otpSystem_1.default.DisableOTP);
//Autres
